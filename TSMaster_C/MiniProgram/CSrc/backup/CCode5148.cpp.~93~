...
// CODE BLOCK BEGIN Documentation  __
...
void on_start_Send_Init(void) { try { // 程序启动事件
 ...
 /*运行窗口 "CAN / CAN FD 报文信息" */
 app.run_form("CAN / CAN FD 报文信息");
...
SendTimer1.stop();
 ...
 /*停止运行窗口 "CAN / CAN FD 报文信息" */
app.stop_form("CAN / CAN FD 报文信息");       
...
// if (ACAN->FIdxChn != CH1) return; // if you want to filter channel
        ...
        /*在系统消息中打印接收到的报文数据*/
       log("接收的CAN数据: 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X", 
